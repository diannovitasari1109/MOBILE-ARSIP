...
class mainListBackup extends StatefulWidget {
  //const mainList({Key? key}) : super(key: key);

  late String idx;

  @override
  State<mainListBackup> createState() => _mainListBackupState();
}

class _mainListBackupState extends State<mainListBackup>
